const poems = [
  ...
  },
  {
    ...
    "author": "晏几道",
    "dynasty": "宋",
    "content": "画屏天畔，梦回山际，水流低。忆得别时无语，一别家山音信杳。莫辞尊前倦，此情怀、谁人晓。最关情、鹦鹉声中，独自归去。",
    "keywords": [
      "语",
      "晓",
      "鹉",
  ...
  },
  {
    ...
    "author": "杜甫",
    "dynasty": "唐",
    "content": "细推物理须行乐，何用浮名绊此身。朝回日日典春衣，每向江头送落晖。共被微官系此身，不如高卧弄松云。醉倒不知谁可共，出门惆怅欲何之。",
    "keywords": [
      "乐",
      "身",
      "如",
...
,

  {
    ...
    "content": "才饮长沙水，又食武昌鱼。万里长江横渡，极目楚天舒。不管风吹浪打，胜似闲庭信步，今日得宽馀。子在川上曰：逝者如斯夫！风樯动，龟蛇静，起宏图。一桥飞架南北，天堑变通途。更立西江石壁，截断巫山云雨，高峡出平湖。神女应无恙，当惊世界殊。",
    "keywords": [
      "西", "在", "截", "动", "者", "界", "峡", "舒", "江", "惊", "昌", "水", "上", "飞", "夫", "立", "步", "通", "出", "应", "饮", "胜", "沙", "楚", "湖", "壁", "食", "一", "曰", "蛇", "鱼", "横", "雨", "北", "不", "日", "变", "殊", "子", "斯", "里", "宽", "天", "极", "逝", "石", "风", "起", "架", "渡", "得", "南", "神", "樯", "云", "目", "断", "宏", "桥", "更", "吹", "龟", "闲", "信", "才", "馀", "长", "庭", "浪", "女", "打", "途", "万", "管", "高", "今", "川", "图", "如", "恙", "平", "无", "当", "似", "武", "静", "山", "世", "又", "堑", "巫"
    ]
  }
,

  {
    ...
    "keywords": [
      "廖", "重", "外", "难", "秋", "易", "胜", "万", "分", "今", "风", "里", "霜", "人", "江", "花", "光", "生", "一", "黄", "劲", "春", "战", "不", "度", "地", "似", "阳", "香", "天", "廓", "老", "年", "又", "岁"
    ]
  }
,

  {
    ...
    "keywords": [
      "漫", "在", "送", "雪", "枝", "中", "崖", "风", "待", "丈", "来", "百", "有", "时", "犹", "花", "俏", "把", "是", "她", "悬", "已", "春", "迎", "雨", "烂", "不", "到", "争", "只", "飞", "报", "归", "笑", "山", "也", "冰", "丛"
    ]
  }
];
